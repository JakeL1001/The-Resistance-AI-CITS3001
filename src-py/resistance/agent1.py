...
class Agent1(Agent): #TODO Rename based on algorithm used
    ...
    def __init__(self, name='Agent1'): # TODO change name
        '''
    ...
    def is_spy(self): # Can leave as is
        '''
        returns True iff the agent is a spy
        '''
        return self.player_number in self.spy_list

    def propose_mission(self, team_size, betrayals_required = 1): # Must select mission based off internal knowledge, If spy, put spies on team, if resistance, put not spies on team
        '''
